...
import { SearchCircleIcon,ServerIcon, CloudUploadIcon, PaperAirplaneIcon,AcademicCapIcon } from '@heroicons/react/solid'
            ...
            <div className='grid md:grid-cols-2 max-w-[1240px] m-auto'>
                ...
                <div className='absolute flex flex-col py-8 md:min-w-[760px]
                 bottom-[5%] mx-1 md:left-1/2 transform md:-translate-x-1/2
                  bg-zinc-200 border border-state-300 rounded-xl text-center shadow-xl'>
                    <p>Data Services</p>
                    <div className='flex justify-between flex-wrap px-4'>
                        <p className='flex px-4 py-2 text-slate-500'><CloudUploadIcon className='h-6 text-indigo-600'/> App Security</p>
                        <p className='flex px-4 py-2 text-slate-500'><SearchCircleIcon className='h-6 text-indigo-600'/> Dashboard Design</p>
